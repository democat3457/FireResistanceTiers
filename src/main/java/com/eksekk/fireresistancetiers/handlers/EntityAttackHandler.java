...
public class EntityAttackHandler
{
	...
	public static final Method blockUsingShield = ObfuscationReflectionHelper.findMethod(ENTITY_CLASS, "func_190629_c", void.class, EntityLivingBase.class);
	public static final Method damageEntity = ObfuscationReflectionHelper.findMethod(ENTITY_CLASS, "func_70665_d", void.class, DamageSource.class, float.class);
	...
	public static final Method getDeathSound = ObfuscationReflectionHelper.findMethod(ENTITY_CLASS, "func_184615_bR", SoundEvent.class);
